...
const STATS = [
  { value: 7, unit: "+", label: "Años de experiencia" },
  { value: 0, unit: "", label: "Accidentes" },
  { value: 24, unit: " / 7", label: "Atención de emergencias" },
  { value: 9, unit: "", label: "Marcas asociadas" },
];
      ...
      <div className="relative z-10 flex-1 flex items-center px-8 md:px-16 pt-12">
        <div className="max-w-5xl">
          <p className="text-[11px] font-medium tracking-[0.3em] uppercase text-volt mb-8 max-sm:max-w-xs">
            Ingeniería eléctrica y sistemas conexos desde 2018.
          </p>
          ...
          >
            Energía
            <br />
            <span className="text-volt">que impulsa</span>
            <br />
            tus proyectos.
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-6 mt-12 items-start">
            <p className="text-muted text-sm leading-relaxed max-w-90">
              Diseñamos, construimos e instalamos soluciones eléctricas
              eficientes, seguras y a la medida de cada proyecto.
            </p>
        ...
        {STATS.map((s, i) => (
          ...
          >
            <div
              ...
              className="text-[2.2rem] text-chalk leading-none"
            >
              {s.value % 1 === 0 ? Math.round(counts[i]) : counts[i].toFixed(1)}
              <span className="text-volt">{s.unit}</span>
            </div>
